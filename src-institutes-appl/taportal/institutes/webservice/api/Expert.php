...
class Expert extends EntityBase {
  ...
  public function __toString() {
    ...
    return "[Expert] {$this->Surname}, {$this->Firstnames}, {$this->ExpTitle}, {$this->EMail}, {$this->PhoneNumber}, " . "{$this->SkypeID}, {$this->Expertise}, {$this->EmplURL}, {$this->Institute}, {$this->TAPublicationURL}, {$this->TAProjectURL}";
  }
