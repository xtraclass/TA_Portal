...
class Institute extends EntityBase {
  ...
  public function __toString() {
    ...
    return "[Institute] {$this->Abbreviation} with {$this->experts->size()} experts and with {$this->publications->size()} publications," . " {$this->Name} {$this->CountryCode} {$this->ZipCode} {$this->City} {$this->Street} {$this->Description} {$this->URL}";
  }
