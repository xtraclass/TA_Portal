...
abstract class EntityBase
{
   ...
   */
  public final function checkMaximumLength( $stringValue, $maximumLength, $fieldName )
  {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  public final function checkExactLength( $stringValue, $fieldName, $exactLength )
  {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  public final function checkExactLengths( $stringValue, $fieldName, $exactLengths )
  {
    if ( is_null( $exactLengths ) or count( $exactLengths ) == 0 or is_null( $fieldName ) or strlen( $fieldName ) == 0 )
    {
      return;
    }
   ...
   */
  protected final function isEmpty( $stringValue )
  {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  protected final function checkDigitsOnly( $stringValue, $fieldName )
  {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  protected final function check1char( $stringValue, $fieldName, $stringValueToCheck, $char )
  {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  private final function checkYear( $stringValue, $fieldName, $value )
  {
    if ( $value < 1000 )
    {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  private final function checkMonth( $stringValue, $fieldName, $value )
  {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  private final function checkDay( $stringValue, $fieldName, $value )
  {
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  protected final function checkDate4or7( $stringValue, $fieldName )
  {
    $previous = NULL;
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  protected final function checkDate4or10( $stringValue, $fieldName )
  {
    $previous = NULL;
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  protected final function checkDate4( $stringValue, $fieldName )
  {
    $exactLength = 4;
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  protected final function checkDate7( $stringValue, $fieldName )
  {
    $exactLength = 7;
    $separator = '-';
    $this->checkExactLength( $stringValue, $fieldName, $exactLength );
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  protected final function checkDate10( $stringValue, $fieldName )
  {
    $exactLength = 10;
    $separator = '-';
    $this->checkExactLength( $stringValue, $fieldName, $exactLength );
   ...
   * @throws InvalidArgumentException If check was not successfull
   */
  private final function checkValidDate( $stringValue, $fieldName, $year, $month = 1, $day = 1 )
  {
